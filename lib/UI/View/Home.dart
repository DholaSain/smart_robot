...
import 'package:smart_robot/UI/Widgets/button.dart';
import 'package:smart_robot/UI/Widgets/buttontapped.dart';
...
//function to connect with microprocessor through https
  void _letsStart() {
    setState(() {
      isStart = false;
...
//function to reset connection with microprocessor through https
  void _letsStop() {
    setState(() {
      isStart = true;
...
//function to start spray with microprocessor through https
...
//function to stop spray with microprocessor through https
  void _letsStopSpray() {
    setState(() {
      sprayButtonPressed = false;
    });
